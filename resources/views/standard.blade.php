...
<section class="room-detail-hero-bg relative h-[350px] md:h-[450px]">
    <div class="container mx-auto px-6 h-full flex flex-col items-center justify-center text-center">
        ...
        <a href="{{ route('booking', ['room' => 'standard']) }}" class="bg-red-500 text-white px-8 py-2.5 rounded-full text-base font-semibold hover:bg-red-600 transition">
            Book Now
        </a>
    </div>
</section>
...
<div class="bg-white rounded-2xl shadow-lg p-6 border-2 border-red-400 self-start">
    ...
    <ul class="space-y-2.5 text-gray-800 mb-6 text-sm">
        <li class="flex items-start">
            <span class="mr-2">•</span>
            <span><strong>Harga:</strong> Rp 700.000 / Bulan</span>
        </li>
        <li class="flex items-start">
            <span class="mr-2">•</span>
    ...
    <div class="flex justify-center">
        <a href="{{ route('booking', ['room' => 'standard']) }}" class="inline-block bg-red-500 text-white px-8 py-2.5 rounded-lg text-base font-semibold hover:bg-red-600 transition">
            Book Now
        </a>
    </div>
</div>
            ...
            <div class="relative carousel-container rounded-2xl overflow-hidden shadow-2xl">
                <div class="carousel-track" id="carouselTrack">
                    ...
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/standardroom.png') }}" alt="Standard Room 1" class="w-full h-[350px] md:h-[450px] object-cover">
                    </div>
                    <!-- Slide 2 -->
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/standard2.png') }}" alt="Standard Room 2" class="w-full h-[350px] md:h-[450px] object-cover">
                    </div>
                    <!-- Slide 3 -->
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/standard3.png') }}" alt="Standard Room 3" class="w-full h-[350px] md:h-[450px] object-cover">
                    </div>
                </div>

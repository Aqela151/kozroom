            ...
            <div class="relative carousel-container rounded-2xl overflow-hidden shadow-2xl">
                <div class="carousel-track" id="carouselTrack">
                    ...
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/bannerutama.png') }}" alt="Deluxe Room 1" class="w-full h-[500px] md:h-[600px] object-cover">
                    </div>
                    <!-- Slide 2 -->
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/deluxe2.png') }}" alt="Deluxe Room 2" class="w-full h-[500px] md:h-[600px] object-cover">
                    </div>
                    <!-- Slide 3 -->
                    <div class="carousel-slide">
                        <img src="{{ asset('assets/deluxe3.png') }}" alt="Deluxe Room 3" class="w-full h-[500px] md:h-[600px] object-cover">
                    </div>
                </div>
